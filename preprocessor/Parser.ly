...
>		ParseMode(..), defaultParseMode, ParseResult(..), hsQuote) where
> 
> import Language.Haskell.Syntax
> import Language.Haskell.ParseMonad
> import Lexer
> import Utils (hsQuote, hsSplice) 
...
>	| gcon				{ $1 }
>  	| literal			{ HsLit $1 }
>	| '[|' exp '|]' 	        { hsQuote $2 }  -- for template haskell
>	| '$(' exp ')'			{ hsSplice $2 } -- for template haskell
>	| '(' exp ')'			{ HsParen $2 }
